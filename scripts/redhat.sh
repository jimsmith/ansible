...
#RHEL 7 Disabling Firewall and Restarting ssh
...
echo "server  58.2.47.148" >> /etc/chrony.conf

systemctl restart chrony
systemctl enable chrony


chkconfig --list | egrep -i 'telnet|rsync|finger|rsh|login' > /var/tmp/chk_log
